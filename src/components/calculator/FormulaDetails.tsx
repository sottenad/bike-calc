  ...
  return (
    <SmallCollapsible title="How are these calculated?">
      <div className="space-y-6">
        ...
        <div>
          <h4 className="font-medium text-gray-900 dark:text-white mb-2">Power-to-Weight Ratio</h4>
          <div className="bg-gray-100 dark:bg-slate-600 rounded p-3 font-mono text-sm">
            W/kg = Power (W) ÷ Rider Mass (kg)
          </div>
          <div className="mt-2 text-sm">
            Your calculation: <span className="font-medium">{power}W ÷ {riderWeight}kg = </span>
            <span className="text-orange-600 dark:text-orange-500 font-medium">{powerToWeight.toFixed(2)} W/kg</span>
          </div>
        </div>
        ...
        {climb && climbResult && (
          <div>
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">Climb Time Calculation</h4>
            <div className="bg-gray-100 dark:bg-slate-600 rounded p-3 font-mono text-sm">
        ...
        {/* Assumptions */}
        <div>
          <h4 className="font-medium text-gray-900 dark:text-white mb-2">Assumptions</h4>
          <ul className="text-sm text-gray-600 dark:text-slate-300 list-disc list-inside space-y-1">
